    ...
    <body>
        ...
        <div class="container">
            <div class="text-center mt-5">
                <h1 class="text-primary negrito mt-5">Endereços de e-mail</h1>
                <span class="text-primary negrito font-size-20 py-1"><?= $nomePerfil ?></span>
                <br />
                <?php
                    if (isset($_SESSION['msgEmailNovo'])) {
                        $msgEmailNovo = $_SESSION['msgEmailNovo'];
				?>
						<span class="text-danger font-size-16 negrito">(<?= $msgEmailNovo ?>)</span>
				<?php 
						unset($_SESSION['msgEmailNovo']);
					}
				?>    
            </div>
            <div class="row">
                ...
                <div class="col-md-6 mt-5">
                    ...
                    <form class="text-center" action="../../controladores/pessoas/valida_email.php" method="post">
                        ...
                        <input class="borda-redonda-10 font-size-20 border-primary py-1 pl-1" type="email" name="email" placeholder="Digite aqui o e-mail...">
