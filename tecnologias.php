...
<html lang="pt-br">
	...
	<body>
		...
		<section class="container">
			...
			<div id="tecnologias-basicas" class="row">
				<div class="col-md-4">
					<div class="row">
						<div class="col-6 d-flex justify-content-center pt-2 pb-2">
					...
					<div class="row">
						<div class="col-6 d-flex justify-content-center pt-2 pb-2">	
							<a href=".bd-example-modal-md-js" data-toggle="modal" data-target=".bd-example-modal-md-js">
								<img src="img/icones/javascript1.png" width="80">
							</a>
						...
						<div class="col-6 d-flex justify-content-center pt-2 pb-2">
							<a href=".bd-example-modal-md-jq" data-toggle="modal" data-target=".bd-example-modal-md-jq">
								<img src="img/icones/jquery1.png" width="80">
							</a>
				...
				<div class="col-md-4">
					<div class="row">
						...
						<div class="col-6 d-flex justify-content-center pt-4 pb-2">
			...
			<div id="tecnologias-programacao" class="row">
				<div class="col-md-6">			
					<div class="row">
			...
			<div id="tecnologias-banco-dados" class="row">
				<div class="col-6 d-flex justify-content-center pt-3 pb-3">
